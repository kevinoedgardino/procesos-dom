...
export default function ProcessCard({ process, event }) {
	return (
        <div aria-label="Más detalles" role="button" onClick={() => event(true, process)} className="block bg-[#22344961] w-80 lg:w-96 p-2 self-center h-min rounded shadow-[0 0 0 1px #000] border-[#30363d] border-2 hover:brightness-110 active:brightness-125 cursor-pointer">
